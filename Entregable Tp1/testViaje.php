...
function recogerDatos(){
    ...
    if ($numeroAsiento>1&&$numeroAsiento<7) {
        ...
        $objPasajeroVip=new PasajeroVip($nViaje,$millas,$nombre,$apellido,$dni,$telefono,$numeroAsiento,$Ticket);
        $pasajero=$objPasajeroVip;
       }if($numeroAsiento>7&&$numeroAsiento<13) {
        echo "necesita servicio especial?";
        ...
        $objPasajeroEspecial=new PasajeroEspecial ($servicioEspecial,$asistencia,$comidaEspeciales,$nombre,$apellido,$dni,$telefono,$numeroAsiento,$Ticket);
      $pasajero=$objPasajeroEspecial;
    }
